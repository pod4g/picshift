...
const de: PageTranslations = {
  home: {
    ...
    description:
      'Konvertieren Sie Bilder sofort in Ihrem Browser. HEIC in JPG, WebP in PNG und mehr. 100% privat -- Ihre Fotos verlassen nie Ihr Geraet. Kostenlos, ohne Limits, ohne Registrierung.',
  },
  privacy: {
