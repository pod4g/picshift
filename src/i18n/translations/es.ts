...
const es: PageTranslations = {
  home: {
    ...
    description:
      'Convierte imagenes al instante en tu navegador. HEIC a JPG, WebP a PNG y mas. 100% privado: tus fotos nunca salen de tu dispositivo. Gratis, sin limites, sin registro.',
  },
  privacy: {
