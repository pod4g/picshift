...
const SEARCH_INTENT_MAP: Partial<Record<Locale, Partial<Record<string, ToolIntentSection[]>>>> = {
  ...
  ru: {
    ...
    'heic-to-webp': [
      ...
      },
      {
        ...
        body: 'Современные браузеры показывают WebP без проблем, но часть старых программ, почтовых клиентов и мессенджеров с ним справляется не всегда. Поэтому WebP — это формат «для веба и хранения», а для отправки людям с непонятной средой лучше держать наготове JPG.',
      },
      {
    ...
    'heic-to-png': [
      ...
      },
      {
        ...
        body: 'Для пересылки по почте, в мессенджерах и для веба, где вес файла важнее абсолютной точности, JPG или WebP практичнее. PNG стоит держать для случаев, когда нужно именно качество без потерь или прозрачный фон.',
      },
    ],
  },
  de: {
  ...
  ar: {
    'heic-to-jpg': [
      {
        title: 'لماذا صور iPhone بصيغة HEIC لا تفتح على Windows',
        body: 'iPhone منذ iOS 11 يلتقط الصور بصيغة HEIC لتوفير المساحة. على iPhone وMac تُفتح مباشرة، لكن Windows 10 وWindows 11 لا يدعمان HEIC افتراضيًا ويحتاجان إضافة مدفوعة من متجر Microsoft. التحويل إلى JPG قبل المشاركة هو الحل الأبسط والأكثر ضمانًا.',
      },
      {
        title: 'متى يكون التحويل إلى JPG هو الخيار الأنسب',
        body: 'اختر JPG عندما ترسل الصورة عبر البريد أو WhatsApp أو تضعها في نماذج رفع على الإنترنت أو تفتحها على جهاز لا تعرف نظامه. JPG هو صيغة الصور الأكثر توافقًا عالميًا، وملفاته أصغر من PNG، ويعمل على أي Windows أو Android أو متصفح.',
      },
      {
    ...
    'heif-to-jpg': [
      {
        title: 'ما الفرق بين HEIF وHEIC ولماذا يهم هذا للتحويل',
        body: 'HEIF هو المعيار العام لحاوية الصور عالية الكفاءة، وHEIC هو تطبيق Apple لهذا المعيار. من ناحية الضغط والفتح هما متطابقان عمليًا، وأداة واحدة تكفي للتعامل مع الامتدادين .heif و.heic. بعض هواتف Samsung تستخدم HEIF أيضًا.',
      },
      {
        title: 'متى يكون JPG أفضل من HEIF لإرسال الصور',
        body: 'إذا كنت سترسل الصورة عبر بريد إلكتروني، WhatsApp، Telegram، أو منصة لا تعرف قدرات الجهاز المستقبِل، فـ JPG هو الخيار الآمن. HEIF يوفر مساحة لكنه يفشل في الفتح على أنظمة قديمة أو تطبيقات لم تُحدَّث.',
      },
      {
